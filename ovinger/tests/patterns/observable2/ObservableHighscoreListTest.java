...
import patterns.observable2.ObservableHighscoreList;
import patterns.observable2.ObservableList;
import patterns.observable2.ObservableListListener;
...
public class ObservableHighscoreListTest extends TestCase {
  ...
  private void _transition_exprAction__listListenerSimple_transitions0_actions0() {
    try {
      ...
      final ObservableListListener _function = (ObservableList list, int pos) -> {
        this.pos2 = pos;
      };
